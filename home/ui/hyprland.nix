...
in
{
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      ...
      # eww toggle
      bindo = ${modifier}, ${modifier}_L, exec, ${pkgs}/bin/eww open-many --toggle central-bar left-bar right-bar
      bindr = ${modifier}, ${modifier}_L, exec, ${pkgs}/bin/eww open-many --toggle central-bar left-bar right-bar
