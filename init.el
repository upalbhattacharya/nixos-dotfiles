...
(custom-set-variables
 ...
 '(package-selected-packages
   '(magit git-auto-commit-mode company lsp-mode org-roam-ui spacious-padding org-super-agenda fzf ivy dashboard org-transclusion org-superstar org-modern org-roam evil catppuccin-theme)))
(custom-set-faces
...
;; org-roam
(setq org-roam-directory (file-truename "~/org/nodes"))
...
(global-set-key (kbd "C-c C-b t") 'org-roam-buffer-toggle)
